...
class UserController {
	...
	public function store() {
		...
		if ( ! isset( $_COOKIE['XpdFromSubmission'] ) ) {
			//Local Timezone
			...
			if ( empty( $error ) ) {
				...
				if ( $buyer ) {
					$cookie_name = "XpdFromSubmission";
					setcookie( $cookie_name, 'from', time() + ( 86400 * 1 ), "/" ); // 86400 = 1 day
			...
			return json_encode( array( "XpdFromSubmission_cookie" => true, "msg" => 'errors' ) );
		}
